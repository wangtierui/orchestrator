...
用法：
  python fill_details.py            # 默认：缺失即补，自动冷却
  python fill_details.py --delay 4  # 更保守的间隔
  python fill_details.py --cooldown 300 --max-consecutive-fail 3
"""
...
import nfra_regulations_scraper as m
