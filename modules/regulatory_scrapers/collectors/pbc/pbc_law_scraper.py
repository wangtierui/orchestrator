...
用法：
  python pbc_law_scraper.py                 # 抓取全部四个栏目
  python pbc_law_scraper.py --category 国家法律   # 仅抓取指定栏目
  python pbc_law_scraper.py --max-items 50       # 限制条目数（调试用）
  python pbc_law_scraper.py --delay 1.2 --out ./out
  python pbc_law_scraper.py --no-attachments     # 不下载附件正文（仅记录链接）
"""
