# -*- coding: utf-8 -*-
"""
parser.py —— 解析/清洗模块（交付标准第三节：scripts/ 按模块拆分）

职责：正文抽取、基础清洗、断句修复、OCR 校正、表格结构还原的按职责封装。
与四源（gov/mof/nfra/pbc）的 scripts/parser.py 结构一致；本项目不携带
crawler_common 模块，文档文本提取基于 pypdf 文本层 + scripts/ocr_pdf.py
...
from ocr_pdf import ocr_scanned  # noqa: E402
